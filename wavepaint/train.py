...
parser.add_argument("-batch", "--Batch_size", default=160, help = "Batch Size")
...
# TrainDataLoaderConfig={'indir': 'celebhq/train_256', 'out_size': 256, 'mask_gen_kwargs': {'irregular_proba': 1, 'irregular_kwargs': {'max_angle': 4, 'max_len': 200, 'max_width': 100, 'max_times': 5,  'min_times': 1}, 'box_proba': 1, 'box_kwargs': {'margin': 10, 'bbox_min_size': 30, 'bbox_max_size': 150, 'max_times': 4, 'min_times': 1}, 'segm_proba': 0}, 'transform_variant': 'no_augs', 
#                                                 'dataloader_kwargs': {'batch_size': TrainBatchSize, 'shuffle': True, 'num_workers': 2}}  
TrainDataLoaderConfig={'indir': 'celebhq/train_256', 'out_size': 256, 'mask_gen_kwargs': {'irregular_proba': 1, 'irregular_kwargs': {'max_angle': 4, 'max_len': 100, 'max_width': 50, 'max_times': 5,  'min_times': 4}, 'box_proba': 0.3, 'box_kwargs': {'margin': 0, 'bbox_min_size': 10, 'bbox_max_size': 50, 'max_times': 5, 'min_times': 1}, 'segm_proba': 0}, 'transform_variant': 'no_augs', 
                                                'dataloader_kwargs': {'batch_size': TrainBatchSize, 'shuffle': True, 'num_workers': 2}}  
...
# PATH = base_path + '_blocks'+str(MODEL_DEPTH)+'_dim'+str(MODEL_EMBEDDING)+'_modules'+str(NUM_MODELS)+'celebhq.pth'

# PATH = 'model.pth
PATH = base_path + '_blocks'+str(NUM_BLOCKS)+'_dim'+str(MODEL_EMBEDDING)+'_modules'+str(NUM_MODULES)+'_celebhq_medium.pth'
# PATH = base_path + '_blocks'+str(NUM_BLOCKS)+'_dim'+str(MODEL_EMBEDDING)+'_modules'+str(NUM_MODULES)+'_level2_depthconv_celebhq.pth'
